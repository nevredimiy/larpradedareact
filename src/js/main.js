...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_touch_or_desktop__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/touch-or-desktop */ "./src/js/functions/touch-or-desktop.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  */
  ...
  const subMenu = menu.querySelectorAll('.menu__sub-list');
  const toggleMenu = () => {
  ...
  if (_functions_touch_or_desktop__WEBPACK_IMPORTED_MODULE_0__.isTouchDevice) {
    ...
    if (menuItemHasChildrens.length > 0) {
      ...
      menuList.forEach(menu => {
        menu.addEventListener('click', e => {
          ...
          if (itemHasChildren) {
            let innerEl = Array.from(itemHasChildren.children);
            // console.log(itemHasChildren);
            // console.log(itemHasChildren.parentNode);
            innerEl.forEach(el => {
              if (el.nodeName == 'UL') {
                closeSubMenu(el);
  ...
  //         let openMenuItem = e.target.closest('._active');
  //         /*
  //         * Здесь дописать
  //        */
